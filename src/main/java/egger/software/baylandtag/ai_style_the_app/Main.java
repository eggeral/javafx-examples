package egger.software.baylandtag.ai_style_the_app;
...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		...
		try {
			...
			// we could also use properties in the configuration an connect them but we do it this way in order not 
			...
			mainScene.getStylesheets().add(Main.class.getPackage().getName().replaceAll("\\.", "/") + "/baylandtag.css");
