...
public class MemberController {
	...
	public void initialize() {
		...
		titleTextField.editableProperty().bind(editable);
		surnameTextField.editableProperty().bind(editable);
		forenameTextField.editableProperty().bind(editable);
		setImageButton.visibleProperty().bind(editable);
		confessionChoiceBox.disableProperty().bind(Bindings.not(editable));
		maritalStatusComboBox.disableProperty().bind(Bindings.not(editable));
